<template>
	<div class="get-multi-image">
		<div class="get-multi-image__multi-image">
			...
			<div class="get-multi-image__image" v-for="(file,index) of files" :key="index" :style="{backgroundImage: `url(${createObjectUrl(file)})`}">
				<div class="get-multi-image__image--ratio"></div>
				<div class="get-multi-image__overlay">
					<div class="get-multi-image__del-btn" @click="deleteImage(index)"></div>
				</div>
			</div>

			<div class="get-multi-image__con-input">
				<input class="get-multi-image__input" type="file" title="افزودن عکس" multiple @change="addImages">
				...
				<div class="get-multi-image__con-input--ratio">
				</div>
			</div>
